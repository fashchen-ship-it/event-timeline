...
export default async function MePage() {
  ...
  return (
    <PageShell>
      ...
      <section className="pixel-card mt-5 p-5"><div className="flex items-center gap-2"><PixelIcon className="size-5 text-[var(--wheat)]" name="calendar" /><h2 className="pixel-title text-lg">记录统计</h2></div><p className="mt-3 text-sm leading-7 text-[var(--soil)]">按月份看看自己留下的事件与重要时刻，不做打卡，也不评判生活。</p><Link className="pixel-button pixel-button-secondary mt-4 min-h-11 px-4 text-sm" href="/insights"><PixelIcon className="size-4" name="calendar" />查看记录统计</Link></section>
